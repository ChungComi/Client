    ...
    <div className="timetable">
      ...
      {modalVisible && (
          <div className="modal-overlay">
            ...
            <div className="modal-section">
              <p>수업명:</p>
              <input type="text" value={className} onChange={(e) => setClassName(e.target.value)} placeholder="수업명을 입력하세요" />
            </div>
            <div className="modal-section">
              <p>교수명:</p>
              <input type="text" value={professor} onChange={(e) => setProfessor(e.target.value)} placeholder="교수명을 입력하세요" />
            </div>
